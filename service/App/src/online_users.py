...
def get_online_users():
    subprocess.Popen(
        ...
        '--no-create-info --net-buffer-length=1048576 --extended-insert=FALSE --compact --hex-blob --where="1 order '
        'by user_id DESC limit 1000" > user_data/online_users/dump.sql',
        shell=True).wait()
    try:
